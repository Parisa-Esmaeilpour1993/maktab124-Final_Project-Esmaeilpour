...
import AddBannerModal from "@/app/components/admin/banner/AddBanerModal";
import BannerList from "@/app/components/admin/banner/BannerList";
import { bannerLocalization } from "@/app/constants/localization/fa/localization";
import { fetchBanners } from "@/app/services/fetchHeroBanner";
  ...
  return (
    <>
      <Button
        ...
        className="!bg-primary m-4 !text-[16px]"
      />

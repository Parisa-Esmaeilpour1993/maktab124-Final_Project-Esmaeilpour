            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div>
                <div>
                  <label
                    htmlFor="fileInp"
                    className="block w-full text-center bg-accent py-2 rounded-md cursor-pointer"
                  >
                ...
                <div>
                  <label className="block">{blogLocalization.title}</label>
                  <Input
                    type="text"
                    name="title"
              ...
              <div className="flex items-center justify-end gap-2 ">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-secondary text-white px-4 py-2 rounded-md hover:bg-primary transition disabled:opacity-50"
                >

...
const SocialButton = () => {
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="social-button">
        <button className="relative w-10 h-10 rounded-full group">
          <div className="floater w-full h-full absolute top-0 left-0 bg-red-600 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl" />
          <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-600 rounded-full">
            <SiGoogle />
          </div>
        </button>
      </div>
      <div className="social-button">
        <button className="relative w-10 h-10 rounded-full group">
          <div className="floater w-full h-full absolute top-0 left-0 bg-green-400 rounded-full duration-400 group-hover:-top-8 group-hover:shadow-2xl" />
